...
class UserModel {
  ...
  static String generateUsername(String fullName) {
    ...
    String username = "$camelCaseUsername"; // Add "cwt_" prefix
    return username;
  }
  ...
  static UserModel empty() {
    return UserModel(
      ...
      firstName: '', // Empty or default value
      lastName: '', // Empty or default value
      username: '', // Empty or default value
      email: '', // Empty or default value
      phoneNumber: '', // Empty or default value
      profilePicture: '', // Empty or default value
    );
  }
